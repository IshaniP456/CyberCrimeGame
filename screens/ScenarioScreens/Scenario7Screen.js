...
export default function Scenario7Screen() {
  ...
  const onPick = (id) => {
    ...
    if (right) {
      // 🔓 mark Scenario 7 as completed for the locking system
      setScenarioCompleted(7);
    }
    ...
    >
      ...
      >
        ...
        <Text style={styles.title}>
          Fake job offers / fake DMV messages with malicious links
        </Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Individuals have reported receiving direct messages and emails
            claiming to be from the DMV or a legitimate company offering remote
            job opportunities. These messages use urgent language and a
            shortened link to push quick clicks. Following the link leads to a
            fake login page that downloads malware.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Figure out who has been sending the messages.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Bullet>
            The sender’s email/username closely mimics an official one but
            contains slight misspellings (“dmvnotice.org” vs “dmv-notice.gov”).
          </Bullet>
          <Bullet>Some job offer messages reference real job apps.</Bullet>
          <Bullet>
            Messages typically arrive early morning or late night, outside
            normal business hours.
          </Bullet>
          <Bullet>
            The phone number was traced to an external country, indicating a
            VPN.
          </Bullet>
        </View>
